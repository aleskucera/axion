...
#         A_ij += _compute_Aij(body_mass_inv, body_inertia_inv, body_a_i, body_a_j, J_ia, J_ja)
#
#     # Term 2: body_a_i vs body_b_j
#     if body_a_i >= 0 and body_a_i == body_b_j:
#         A_ij += _compute_Aij(body_mass_inv, body_inertia_inv, body_a_i, body_b_j, J_ia, J_jb)
#
#     # Term 3: body_b_i vs body_a_j
#     if body_b_i >= 0 and body_b_i == body_a_j:
#         A_ij += _compute_Aij(body_mass_inv, body_inertia_inv, body_b_i, body_a_j, J_ib, J_ja)
#
#     # Term 4: body_b_i vs body_b_j
#     if body_b_i >= 0 and body_b_i == body_b_j:
#         A_ij += _compute_Aij(body_mass_inv, body_inertia_inv, body_b_i, body_b_j, J_ib, J_jb)
#
