...
def _parse_args():
    p = argparse.ArgumentParser(
        description="Train transformer-based MSE regression network from YAML config."
    )
...
if __name__ == "__main__":
    ...
    if not args.train:
        raise NotImplementedError("--test is not implemented yet for train_mse.py.")
