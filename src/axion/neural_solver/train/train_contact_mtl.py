...
from axion.neural_solver.algorithms.contact_mtl_trainer import ContactMTLTrainer
...
def _parse_args():
    p = argparse.ArgumentParser(
        description="Train transformer-based contact multi-task network from YAML config."
    )
...
if __name__ == "__main__":
    ...
    if not args.train:
        raise NotImplementedError("--test is not implemented yet for train_contact_mtl.py.")
    ...
    cfg["network"]["model_impl"] = "contact_mtl"
    ...
    print("Begin Contact MTL training")
    algo.train()
