...
class Example:
    def __init__(self, viewer, num_worlds):
        ...
        quadruped.default_joint_cfg.mode = newton.JointMode.NONE
        quadruped.default_joint_cfg.target_ke = 0.0  # 2000.0
        quadruped.default_joint_cfg.target_kd = 0.0  # 1.0
        quadruped.default_shape_cfg.ke = 1.0e4
        quadruped.default_shape_cfg.kd = 1.0e2
        quadruped.default_shape_cfg.kf = 1.0e2
        quadruped.default_shape_cfg.mu = 0.5
        quadruped.default_shape_cfg.restitution = 0.0
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num-worlds", type=int, default=1, help="Total number of simulated worlds."
    )
