...
class Example:
    def __init__(self, viewer, options):
        ...
        sand_particles, snow_particles, mud_particles = Example.emit_particles(
            builder, voxel_size=options.voxel_size
        )
    ...
    def _spawn_particles(
        builder: newton.ModelBuilder, voxel_size, bounds_lo, bounds_hi, density, flags
    ):
