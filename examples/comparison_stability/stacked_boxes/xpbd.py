"""Stacked-boxes stability benchmark — Newton XPBD solver (position-based dynamics).
...
Usage:
    python examples/comparison/stacked_boxes/xpbd.py \
        --save examples/comparison/stacked_boxes/results/xpbd.json
"""
import argparse
import json
import os
...
def run_one(dt: float, engine_config: XPBDEngineConfig) -> dict:
