"""Plot per-iteration timing for the helhest gradient optimization benchmark.

Usage:
    python examples/comparison/helhest/plot_results.py
    python examples/comparison/helhest/plot_results.py --show
"""
import argparse
import json
import pathlib
