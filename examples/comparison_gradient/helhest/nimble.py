...
Setup:
    ...
    .venv-nimble/bin/python examples/comparison/helhest/nimble.py
    .venv-nimble/bin/python examples/comparison/helhest/nimble.py --plot
    .venv-nimble/bin/python examples/comparison/helhest/nimble.py --save examples/comparison/helhest/results/nimble.json
