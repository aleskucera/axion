"""Sliding box optimization using diffarticulated (ICML 2021).

Usage:
    python examples/comparison_gradient/sliding_box/diffarticulated_sim.py --save results/diffarticulated.json
"""
import argparse
import json
import os
...
def run_in_docker(args):
    ...
    cmd = [
        ...
        "python3", "python/sliding_box_benchmark.py"
    ]
    
    print(f"Executing diffarticulated sliding_box inside Docker container '{container_name}'...")
