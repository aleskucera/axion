"""Plot per-iteration timing for the curling-box gradient optimization benchmark.

Usage:
    python examples/comparison/curling_box/plot_results.py
    python examples/comparison/curling_box/plot_results.py --show
"""
import argparse
import json
import pathlib
