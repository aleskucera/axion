...
class HelhestTrajectoryOptimizer(AxionDifferentiableSimulator):
    def __init__(
        ...
        # Normalize by number of timesteps so weight is comparable to endpoint.py
    ...
    def render(self, train_iter):
        ...
        target_poses = self.trajectory.target_body_pose.numpy()  # [T+1, worlds, bodies]
        num_steps = target_poses.shape[0]

        # Draw target waypoints every 10 timesteps
