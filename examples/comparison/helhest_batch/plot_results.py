"""Plot per-iteration timing for the helhest batch (100-world) benchmark.

Usage:
    python examples/comparison/helhest_batch/plot_results.py
    python examples/comparison/helhest_batch/plot_results.py --show
"""
import argparse
import json
import pathlib
...
def main():
    ...
    ax.set_xlabel(rf"ms\,/\,iter (median $\pm$ IQR, {num_worlds} worlds)")
