...
Setup:
    ...
    python examples/comparison/curling_box/genesis.py
    python examples/comparison/curling_box/genesis.py --save examples/comparison/curling_box/results/genesis.json
"""
import argparse
import json
import math
