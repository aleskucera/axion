...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Rosbag directory; use /cmd_vel (diff-drive kinematic) as wheel target",
    )
    parser.add_argument(
        "--ctrl",
        type=float,
    ...
    if args.ground_truth:
        ...
        if args.bag:
            ...
            ref_ts = (gt["wheel_velocities"]["timeseries"]
            ...
            print(f"  Using /cmd_vel-derived wheel targets "
